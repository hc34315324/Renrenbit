  ...
  function($scope, $log, $stateParams, configService, applicationService, profileService, storageService, appConfigService) {
    ...
    $scope.save = function() {
      ...
      switch ($scope.bwsurl.value) {
        case 'prod':
        case 'production':
          bws = 'http://192.168.1.5:3232/bws/api'              //https://bws.bitpay.com/bws/api
          break;
        case 'sta':
        case 'staging':
          bws = 'http://192.168.1.5:3232/bws/api'              //https://bws-staging.b-pay.net/bws/api
          break;
        case 'loc':
        case 'local':
          bws = 'http://192.168.1.5:3232/bws/api'
          break;
      };
      if (bws) {
