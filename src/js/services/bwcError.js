      ...
      if (name) {
        switch (name) {
          ...
          case 'COPAYER_IN_WALLET':
            body = gettextCatalog.getString('Renrenbiter already in this wallet');
            break;
          case 'WALLET_FULL':
          ...
          case 'LOCKED_FUNDS':
            ...
            break;
          case 'COPAYER_VOTED':
            body = gettextCatalog.getString('Renrenbiter already voted on this spend proposal');
            break;
          case 'NOT_AUTHORIZED':
          ...
          case 'TX_NOT_PENDING':
            ...
            break;
          case 'UPGRADE_NEEDED':
            body = gettextCatalog.getString('Please upgrade Renrenbit to perform this action');
            break;
          case 'BAD_SIGNATURES':
            body = gettextCatalog.getString('Signatures rejected by server');
            break;
          case 'COPAYER_DATA_MISMATCH':
            body = gettextCatalog.getString('Renrenbiter data mismatch');
            break;
          case 'DUST_AMOUNT':
